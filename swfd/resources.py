# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/04_resources.ipynb (unless otherwise specified).

__all__ = ['back', 'getInfo', 'NBeatsNet', 'squeeze_last_dim', 'seasonality_model', 'trend_model', 'linear_space',
           'Block', 'SeasonalityBlock', 'TrendBlock', 'GenericBlock']
